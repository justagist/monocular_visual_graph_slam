...
{ 
    namespace SlamParameters   
    {
        ...
        // ----- Location of the fabmap_training_data folder for FabMap
        const std::string fabmap_training_data_destination_ = "/home/saif/ros_ws/other_ws/src/graph_slam/fabmap_training_data/";
    } 
}
