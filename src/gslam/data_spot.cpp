...
DataSpot3D::DataSpot3D(const customtype::TransformSE3& pose, 
                                 ...
                                 const customtype::KeyPoints& img_pts) : pose_(pose), id_(next_id_s++), added_to_graph_(false), camParams_(camParams), image_color_(image_color), projectionMat_(projectionMatrix), world_pts_(world_pts), keypoints_(img_pts)
{
}
